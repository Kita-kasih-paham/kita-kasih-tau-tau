            ...
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="text-muted"
                        ...
                        Bahan Baku</div>
                    <div class="fs-3 fw-bold"><?= $totalBahanBaku ?></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card h-100" style="border-left:4px solid #8b5cf6">
            <div class="card-body d-flex align-items-center gap-3">
                <div class="stat-icon" style="background:rgba(139,92,246,0.1)">
                    <i class="bi bi-grid-3x3-gap" style="color:#8b5cf6"></i>
                </div>
                <div>
                    <div class="text-muted"
                        style="font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:.4px">Total
    ...
    <div class="col-12 col-md-3">
        <div class="card h-100" style="border-left:4px solid #0e9f6e">
            <div class="card-body d-flex align-items-center gap-3">
                ...
                <div>
                    <div class="text-muted"
                        style="font-size:0.75rem;font-weight:600;text-transform:uppercase;letter-spacing:.4px">Stok
                        Masuk</div>
            ...
            <div style="padding:1.25rem 1.5rem;background:#fff;border-bottom:1px solid #f3f4f6">
                <div class="d-flex align-items-center gap-2">
                    ...
                    <span style="color:#78350f;font-size:0.9rem">
                        <strong style="color:#1f2937">Bahan baku</strong> dengan stok <strong>kurang dari 5</strong> unit.
                        Segera lakukan restok untuk menghindari
                        kekosongan stok yang dapat menghambat produksi.
                    </span>
                </div>
            </div>
                            ...
                            <tr style="transition:background 0.2s ease" onmouseover="this.style.background='#fef3c7'"
                                ...
                                <td style="padding:1rem 1.5rem;vertical-align:middle;border-bottom:1px solid #f3f4f6">
                                    <span
                                        ...
                                        <?= htmlspecialchars($item['kode_bahan']) ?>
                                    </span>
                                </td>
                                <td
...
<?php if (!empty($inactiveItems)): ?>
    <div class="card mb-4" style="border:none;box-shadow:0 4px 12px rgba(107,114,128,0.15);overflow:hidden">
        <!-- Header with gradient -->
        <div class="card-header"
            style="background:linear-gradient(135deg, #6b7280 0%, #4b5563 100%);border:none;padding:1.25rem 1.5rem">
            <div class="d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    <div
                        style="width:48px;height:48px;background:rgba(255,255,255,0.2);backdrop-filter:blur(10px);border-radius:12px;display:flex;align-items:center;justify-content:center">
                        <i class="bi bi-toggle-off" style="font-size:1.5rem;color:#fff"></i>
                    </div>
                    <div>
                        <h5 class="mb-0" style="color:#fff;font-weight:700;font-size:1.1rem">
                        ...
                        <p class="mb-0" style="color:rgba(255,255,255,0.9);font-size:0.875rem;margin-top:0.25rem">
                            Bahan baku yang sudah tidak digunakan atau tidak di-restock lagi
                        </p>
                    </div>
                </div>
                <div
                    style="background:rgba(255,255,255,0.25);backdrop-filter:blur(10px);padding:0.5rem 1rem;border-radius:20px">
                    <span style="color:#fff;font-weight:700;font-size:1.25rem"><?= count($inactiveItems) ?></span>
                    <span style="color:rgba(255,255,255,0.9);font-size:0.875rem;margin-left:0.25rem">items</span>
                </div>
            </div>
        </div>
        ...
        <!-- Content -->
        <div class="card-body" style="padding:0;background:#f9fafb">
            <div style="padding:1.25rem 1.5rem;background:#fff;border-bottom:1px solid #f3f4f6">
                <div class="d-flex align-items-center gap-2">
                    <i class="bi bi-info-circle" style="color:#6b7280"></i>
                    <span style="color:#4b5563;font-size:0.9rem">
                        Bahan baku ini tidak muncul di peringatan stok rendah.
                        Aktifkan kembali di <a href="/bahan-baku" style="color:#0f6cbd;text-decoration:none"><strong>halaman
                                Bahan Baku</strong></a> jika diperlukan.
                    </span>
                </div>
            </div>
                ...
                <table class="table mb-0" style="font-size:0.9rem">
                    ...
                    <tbody>
                        <?php foreach ($inactiveItems as $item): ?>
                            <tr style="transition:background 0.2s ease" onmouseover="this.style.background='#f3f4f6'"
                                onmouseout="this.style.background='transparent'">
                                <td style="padding:1rem 1.5rem;vertical-align:middle;border-bottom:1px solid #f3f4f6">
                                    <span
                                        style="background:linear-gradient(135deg, #6b7280 0%, #4b5563 100%);color:#fff;padding:0.35rem 0.75rem;border-radius:6px;font-weight:600;font-size:0.85rem;display:inline-block">
                                        <?= htmlspecialchars($item['kode_bahan']) ?>
                                    </span>
                                </td>
                                <td
                                ...
                                <td
                                    style="padding:1rem 1.5rem;text-align:center;vertical-align:middle;border-bottom:1px solid #f3f4f6">
                                    <span
                                        style="background:#e5e7eb;color:#4b5563;padding:0.45rem 1rem;border-radius:8px;font-weight:600;font-size:0.95rem;display:inline-flex;align-items:center">
                                        <?= fmt($item['stok_tersedia']) ?>
                                    </span>
                                </td>
                            </tr>
                        <?php endforeach; ?>
            ...
            <div style="padding:1rem 1.5rem;background:#fff;border-top:1px solid #f3f4f6">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span style="color:#6b7280;font-size:0.875rem">
                            Bahan baku ini sudah dinonaktifkan dan tidak akan muncul di peringatan stok
                        </span>
                    </div>
                    <a href="/bahan-baku" class="btn btn-sm"
                        style="background:linear-gradient(135deg, #6b7280 0%, #4b5563 100%);color:#fff;border:none;padding:0.5rem 1.25rem;border-radius:8px;font-weight:600;box-shadow:0 2px 8px rgba(107,114,128,0.3);transition:all 0.2s ease"
                        onmouseover="this.style.transform='translateY(-2px)';this.style.boxShadow='0 4px 12px rgba(107,114,128,0.4)'"
                        onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 2px 8px rgba(107,114,128,0.3)'">
...
<!-- Last Added Bahan Baku -->
<div class="card mb-2">
    <div class="card-header d-flex align-items-center gap-2">
        <i class="bi bi-box-seam text-primary"></i>
        <span>Bahan Baku Terakhir Ditambahkan</span>
    </div>
    <div class="card-body p-0">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        $('#tblBahanBaku').DataTable(dtConfig);
    });
</script>
