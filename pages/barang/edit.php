...
// $barang is set by controller
$val = fn(string $field) => htmlspecialchars($old[$field] ?? $barang[$field] ?? '');
ob_start();
?>
<div class="row justify-content-center">
<div class="col-12 col-md-7 col-lg-6">
<div class="card">
    <div class="card-header"><i class="bi bi-pencil-square me-2 text-primary"></i>Edit Barang</div>
        ...
        <form action="/barang/<?= $barang['id'] ?>/update" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kode_barang"
                       ...
                       value="<?= $val('kode_barang') ?>" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_barang"
                       ...
                       value="<?= $val('nama_barang') ?>" required>
    ...
    function render(filter) {
        ...
        dropdown.innerHTML = filtered.map(u =>
            `<div class="satuan-item" data-val="${u}"
                  style="padding:0.5rem 0.85rem;cursor:pointer;font-size:0.875rem;color:#1a2332">${u}</div>`
        ).join('');
...
<?php $content = ob_get_clean(); renderLayout('Edit Barang', $content); ?>
