<?php require_once __DIR__ . '/../../shared/components.php'; ob_start(); ?>
        ...
        <table id="tblStokTersedia" class="table mb-0" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge px-2 py-1" style="font-size:0.82rem;background:<?= $row['stok_tersedia'] > 0 ? 'rgba(14,159,110,0.12);color:#0e9f6e' : 'rgba(224,36,36,0.12);color:#e02424' ?>">
...
<?php $content = ob_get_clean(); renderLayout('Stok Tersedia', $content); ?>
